...
def generate_password():
    ...
    if not characters:
        messagebox.showwarning("Warning", "Character pool is empty after excluding characters.")
        return
...
length_entry = tk.Entry(root, textvariable=length_var, bg=BG_COLOR, fg=FG_COLOR)
length_entry.grid(row=0, column=1, padx=10, pady=10)

upper_checkbutton = tk.Checkbutton(root, text="Include Uppercase Letters", variable=upper_var, bg=BG_COLOR, fg=FG_COLOR)
upper_checkbutton.grid(row=1, column=0, padx=10, pady=5)
lower_checkbutton = tk.Checkbutton(root, text="Include Lowercase Letters", variable=lower_var, bg=BG_COLOR, fg=FG_COLOR)
lower_checkbutton.grid(row=1, column=1, padx=10, pady=5)
number_checkbutton = tk.Checkbutton(root, text="Include Numbers", variable=number_var, bg=BG_COLOR, fg=FG_COLOR)
number_checkbutton.grid(row=2, column=0, padx=10, pady=5)
special_checkbutton = tk.Checkbutton(root, text="Include Special Characters", variable=special_var, bg=BG_COLOR, fg=FG_COLOR)
special_checkbutton.grid(row=2, column=1, padx=10, pady=5)

tk.Label(root, text="Exclude Characters:", bg=BG_COLOR, fg=FG_COLOR).grid(row=3, column=0, padx=10, pady=5)
exclude_entry = tk.Entry(root, textvariable=exclude_var, bg=BG_COLOR, fg=FG_COLOR)
exclude_entry.grid(row=3, column=1, padx=10, pady=5)

generate_button = tk.Button(root, text="Generate Password", command=generate_password, bg=ACCENT_COLOR, fg="white")
generate_button.grid(row=4, column=0, columnspan=2, padx=10, pady=10)

password_entry = tk.Entry(root, textvariable=password_var, width=40, state='readonly', bg=BG_COLOR, fg=FG_COLOR)
password_entry.grid(row=5, column=0, columnspan=2, padx=10, pady=10)

copy_button = tk.Button(root, text="Copy to Clipboard", command=copy_to_clipboard, bg=ACCENT_COLOR, fg="white")
